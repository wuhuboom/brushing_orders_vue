<template>
  <div class="w-full min-h-[100vh]">
    ...
    >
      ...
      <div class="w-full box-border flex flex-col px-[10px]">
        <div class="w-full mb-4 p-2 rounded-lg bg-[#fff] flex items-center" v-for="item in levelList">
            <div class="flex flex-col flex-1">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                      <img :src="bgMapStart[item.name]" class="w-[48px] h-[48px] mr-[6px]" alt="">
                      <div class="text-[20px] text-[#1F2937] font-semibold mr-2">{{item.name}}{{$t('体验卡')}}</div>
                    </div>
                </div>
...
const bgMapStart = {
  VIP1: new URL("@/static/images/vip1.png", import.meta.url).href,
  VIP2: new URL("@/static/images/vip2.png", import.meta.url).href,
  VIP3: new URL("@/static/images/vip3.png", import.meta.url).href,
  VIP4: new URL("@/static/images/vip4.png", import.meta.url).href,
  VIP5: new URL("@/static/images/vip5.png", import.meta.url).href,
};
const levelList = ref([]);
const level = async () => {
  ...
  levelList.value.forEach(item => {
     if (item.description) {
      ...
      item.description = item.description.replace(
        /(●|•|&#8226;|&#9679;)/g,
        `<span class="inline-block w-[5px] h-[5px] bg-black rounded-full mr-2 align-middle"></span>`
      )
    }
  });
