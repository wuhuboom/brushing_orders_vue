<template>
  <div class="w-full min-h-[100vh] bg-[#f8f8f8]">
    <div class="container w-full mb-[60px] bg-white">
      <PageTopBar :title="$t('deposit')" show-back @click-left="onClickLeft" />
    </div>
    <div class="px-[15px] bg-[#fff] pb-[10px] my-[10px]">
        <div class="text-[15px] text-[#333] font-bold py-[10px] mb-[10px]" style="border-bottom: 1px solid #eee;">{{$t('payment_method')}}</div>
    ...
    <div class="px-[15px] bg-[#fff] pb-[10px] my-[10px]">
        <div class="text-[15px] text-[#333] font-bold py-[10px] mb-[10px]" style="border-bottom: 1px solid #eee;">{{$t('select_the_protocol_to_use')}}</div>
    ...
    <div class="px-[15px] bg-[#fff] pb-[10px] my-[10px]">
        <div class="text-[15px] text-[#333] font-bold py-[10px] mb-[10px]" style="border-bottom: 1px solid #eee;">{{$t('currency_selection')}}</div>
    ...
    <div class="px-[15px] bg-[#fff] pb-[10px] my-[10px]">
        <div class="text-[15px] text-[#333] font-bold py-[10px] mb-[10px]" style="border-bottom: 1px solid #eee;">{{$t('deposit_amount')}}</div>
        <div
      ...
      > 
        ...
        <van-field
          ...
          size="large"
        />
        <div class="absolute right-0 top-[13px] text-[12px] text-[#2563EB]"  @click="All">{{ $t("all") }}</div>
      </div>
    </div>
    <div class="px-[16px]" style="border-bottom: 2px solid #eee; padding-bottom: 10px;">
        <div class="text-[#333] text-[12px] pb-[10px]">{{$t('estimated_payment_amount')}}:{{amount}}USDT</div>
        <div class="text-[#333] text-[12px]">{{$t('reference_exchange_rate')}}：1 USDT ≈ 1 USDT</div>
        <div class="text-[#999] text-[12px] ">{{$t('payment_amount_and_exchange_rate_are_subject_to_actual_payment')}}.</div>
    </div>
