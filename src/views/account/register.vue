    ...
    <div class="flex flex-col items-center mt-6 pb-1">
	  ...
	  <div class="panel">
		  ...
		  <el-form
		    ...
		    class="w-full mt-4"
		  >
			<div class="font-semibold pb-2">{{ $t("用户名") }}<span class="text-red ml-1">*</span></div>
			...
			<div class="font-semibold pb-2">{{ $t("密码") }}<span class="text-red ml-1">*</span></div>
			...
			<div class="font-semibold pb-2">{{ $t("确认密码") }}<span class="text-red ml-1">*</span></div>
			...
			<div class="font-semibold pb-2">{{ $t("电话") }}<span class="text-red ml-1">*</span></div>
		   <!-- <el-form-item label="" prop="phone" label-position="top">
			...
			<div class="font-semibold pb-2">{{ $t("交易密码") }}<span class="text-red ml-1">*</span></div>
			...
			<div class="font-semibold pb-2">{{ $t("性别") }}<span class="text-red ml-1">*</span></div>
