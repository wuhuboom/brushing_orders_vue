<template>
  <div class="pt-5 relative flex items-center w-full">
    <button
      type="button"
      class="h-9 w-9 bg-gray flex items-center justify-center rounded-2.5"
      @click="toBack"
    >
      <img
        src="@/static/brain/back.png"
        alt=""
        style="height: 18px; width: 18px"
      />
    </button>
    <div
      class="ml-auto h-9 w-9 bg-gray flex items-center justify-center rounded-2.5"
    ...
    <div
      class="ml-auto h-9 w-9 bg-gray flex items-center justify-center rounded-2.5"
      v-if="rightType === 'crypto' || rightType === 'bank'"
      @click="toAdd"
    >
      <el-icon size="18">
        <Plus />
    ...
    <div
      class="ml-auto h-9 w-9 bg-red flex items-center justify-center rounded-2.5"
      v-if="rightType === 'delete'"
    ...
    <div class="w-full ml-5" v-if="showTabs">
      <Tabs
        :menus="tradeTypeList"
        :selectMenu="tradeStore.tradeType"
